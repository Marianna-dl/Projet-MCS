...
public class ArreteToiActivity extends Activity {

    private static final String LOG_TAG = "ArreteToiActivity";
    private static final String NAME_FILE = "arretetoi.wav";
