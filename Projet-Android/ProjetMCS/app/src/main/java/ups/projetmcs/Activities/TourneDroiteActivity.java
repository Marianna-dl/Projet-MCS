...
public class TourneDroiteActivity extends Activity {

    private static final String LOG_TAG = "TourneDroiteActivity";
    private static final String NAME_FILE = "tournedroite.wav";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.tourne_droite_layout);
        setPoliceTitles();
        mRecordButton = (RecordButton) findViewById(R.id.btnRecord);
        mPlayButton = (PlayButton) findViewById(R.id.btnPlay);
        RadioGroup radioGroup = (RadioGroup) findViewById(R.id.radioGroupTourneDroite);
