...
public class ReculeActivity extends Activity {

    private static final String LOG_TAG = "ReculeActivity";
    private static final String NAME_FILE = "recule.wav";
    ...
    public void onCreate(Bundle icicle) {
        ...
        RadioGroup radioGroup = (RadioGroup) findViewById(R.id.radioGroupRecule);
